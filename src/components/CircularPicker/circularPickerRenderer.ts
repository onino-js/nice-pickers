...
export const circularPickerRender = (container: any) => {
  ...
  const mainCircle = d3
    ...
    // const menu = d3.select(container).select('menu-icon')
    // console.log(menu)
    // mainCircle.append


// Close picker when user click outside AND the picker is opened
