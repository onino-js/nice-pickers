...
class Scope {
  ...
  migrate(verbose) {
    ...
    return (0, _bluebird().coroutine)(function* () {
      _logger().default.debug('scope.migrate, running migration process for scope');
      ...
      if (_semver().default.gte(scopeVersion, _constants().BIT_VERSION)) {
        ...
        _logger().default.debug(`scope.migrate, ${upToDateMsg}`);
  ...
  findDirectDependentComponents(componentsPool, potentialDependencies) {
    ...
    return (0, _bluebird().coroutine)(function* () {
      const componentsVersions = yield _this20.loadLocalComponents(componentsPool);
      const dependentsP = componentsVersions.map(
      /*#__PURE__*/
      function () {
        var _ref8 = (0, _bluebird().coroutine)(function* (componentVersion) {
          const component = yield componentVersion.getVersion(_this20.objects);
  ...
  runComponentSpecs({
    ...
    return (0, _bluebird().coroutine)(function* () {
      if (!bitId.isLocal(_this21.name)) {
        throw new (_generalError().default)('cannot run specs on remote component');
      }

      const component = yield _this21.getConsumerComponent(bitId);
  ...
  loadModelComponentByIdStr(id) {
    ...
    return (0, _bluebird().coroutine)(function* () {
      ...
      return _this23.objects.load(ref);
    })();
  }
  /**
  ...
  isIdHasScope(id) {
    ...
    return (0, _bluebird().coroutine)(function* () {
      const component = yield _this24.loadModelComponentByIdStr(id);
  ...
  getParsedId(id) {
    ...
    return (0, _bluebird().coroutine)(function* () {
      const idHasScope = yield _this25.isIdHasScope(id);
